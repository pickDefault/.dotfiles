...
k({ 'n' }, 'mcs', cursors.flash_char, { expr = false, desc = 'Create cursor using flash' })
k({ 'n' }, 'mcw', cursors.flash_word, { expr = false, desc = 'Create selection using flash' })
...
vim.keymap.set({ 'n', 'x', 'i' }, "<C-m>", function()
  ...
  vim.defer_fn(function()
    require('nvim-treesitter.configs').setup {
      ...
      ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'java', 'dart' },
